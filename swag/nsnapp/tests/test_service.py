...
class DeveloperRatesServiceTest(unittest.TestCase):
    ...
    def test_01_save_developer_rates_success(
        self, MockReplaceOne, MockDatetime, MockCollection
    ):
        """
    ...
    def test_02_save_developer_rates_invalid_rate(self):
        ...
        with self.assertRaisesRegex(
            ValueError, "O campo 'valor_por_hora' deve ser um número válido."
        ):
    ...
    def test_03_save_developer_rates_missing_field(self):
        ...
        with self.assertRaisesRegex(
            ValueError, "Cada objeto deve ter 'id_desenvolvedor' e 'valor_por_hora'."
        ):
            save_developer_rates_service(data)
